...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception{
        httpSecurity
                ...
                .antMatchers(HttpMethod.POST, "/api/v1/pokemon/").hasRole("ADMIN")
                .antMatchers(HttpMethod.PUT, "/api/v1/pokemon/").hasRole("ADMIN")
                .antMatchers(HttpMethod.PUT, "/api/v1/users/").hasRole("EDITOR")
